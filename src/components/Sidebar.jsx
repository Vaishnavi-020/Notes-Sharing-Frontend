...
return (
    ...
    <div className={`fixed top-0 left-0 h-full w-64 bg-gradient-to-br from-sky-50 to-indigo-200 text-stone-900 z-50 duration-300 ${isOpen?"translate-x-0":"-translate-x-full"}`}>
        ...
        <nav className="p-4 space-y-3">
            ...
            <Link className="block p-2 rounded hover:bg-gradient-to-br from-sky-100 to-indigo-500 hover:text-blue-800" to="/dashboard">Dashboard</Link>
            <Link className="block p-2 rounded hover:bg-gradient-to-br from-sky-100 to-indigo-500 hover:text-blue-800" to="#">Settings</Link>
        </nav>  
